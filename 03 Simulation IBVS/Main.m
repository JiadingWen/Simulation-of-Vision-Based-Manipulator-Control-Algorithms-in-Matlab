...
for i = 1:iteration_limit
    ...
    T_c1_s = inv(T_s_e_current);  %equation 2.3
    m_c1_i = Camera_3to2(X_s_i_set,T_c1_s); %equation 2.4
    ...
    s = Calculate_s(m_c1_i,a); %equation 2.8
    ...
    z_c_i = Calculate_z_c(m_c1_i,m_c2_i,a,b);
    
   %% Spatial Velocity Calculation
    
    % Calculate Moore-Penrose inverse of Ls
    Ls = Calculate_Ls(s,z_c_i);   % equation 2.13
    Ls_inverse = pinv(Ls);
